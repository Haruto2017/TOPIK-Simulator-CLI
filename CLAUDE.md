...
- `src/topik_sim/courses.py` / `homework.py` — guided courses over a pack and per-lesson auto-generated homework (recall, meaning/pattern choice, cloze) with saved best scores
